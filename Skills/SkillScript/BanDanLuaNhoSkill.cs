...
public class BanDanLuaNhoSkill : SkillControl
{
    ...
    public override IEnumerator SkillOvertime()
    {
        ...
        NetworkObject skillEffect = Runner.Spawn(useSkillEffectPrefab, firePoint.position, firePoint.rotation);
